...
| [Running on Bun](bun-runtime.md) | What Bun does natively, why tsx drops out, and the lockfile rule. |
| [Testing and coverage](testing-with-bun-test.md) | Bun's runner, the weaker coverage floor in bunfig.toml, and what was traded away. |
